System.register(['aurelia-dependency-injection', 'aurelia-templating', '../common/widget-base', '../common/decorators', '../common/constants'], function (_export, _context) {
  ...
  var inject, customAttribute, bindable, WidgetBase, generateBindables, constants, _dec, _dec2, _dec3, _class, _desc, _value, _class2, _descriptor, _descriptor2, TextBox;
  ...
  return {
    ...
    execute: function () {
      _export('TextBox', TextBox = (_dec = customAttribute(constants.attributePrefix + 'textbox'), _dec2 = generateBindables('kendoTextBox'), _dec3 = inject(Element, WidgetBase), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = function () {
      ...
      _export('TextBox', TextBox);
    }
  };
});
//# sourceMappingURL=../dist/dev/textbox/textbox.js.map
